...
@section('content')
    <!-- principal -->
        ...
        <div class="row pt-5">
            <div class="col-lg-9">
                <h1 class="text-azul h2 text-uppercase fw-bold mb-0"> Nuevo Producto</h1>
                                ...
                                <div class="col-12 col-lg-7 py-1">
                                    <div class="row">
                                        <div class="col-12 col-lg-4 py-1">
                                            ...
                                            <input type="text" name="codigo" disabled id="codigo" class="float-end form-control form-control-sm  fw-light" value="{{$codigo}}" maxLength="100">  
                                            @error('codigo')
                                        ...
                                        <div class="col-12 col-lg-4 py-1">
                                            ...
                                            <input type="text" name="name" id="name" class="float-end form-control form-control-sm  fw-light" value="{{old('name')}}" maxLength="100">  
                                            @error('name')
                                                <small class="text-danger">{{$message}}</small>
                                            @enderror
                                        </div>
                                        <div class="col-12 col-lg-4 py-1">
                                            ...
                                            <select class="form-select select2 form-select-sm" name="marca_id" id="marcas_id" >
                                                <option value="{{old('marca_id')}}" disabled="disabled" selected="selected" hidden="hidden">{{old('marca_id')}}</option>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-4 py-1">
                                            ...
                                            <select class="form-select select2 form-select-sm" name="medida_id" id="unidads_id" >
                                                <option value="{{old('medida_id')}}" disabled="disabled" selected="selected" hidden="hidden">{{old('medida_id')}}</option>
                                        ...
                                        <div class="col-12 col-lg-4 py-1">
                                            ...
                                            <select class="form-select select2 form-select-sm" name="categoria_id" id="categorias_id" >
                                                <option value="{{old('category_id')}}" disabled="disabled" selected="selected" hidden="hidden">{{old('category_id')}}</option>
                                        ...
                                        <div class="col-12 col-lg-4 py-1">
                                            ...
                                            <select class="form-select select2 form-select-sm" name="presentacion_id" id="presentacion_id" >
                                                <option value="{{old('presentacion_id')}}" disabled="disabled" selected="selected" hidden="hidden">{{old('presentacion_id')}}</option>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-lg-12 py-1">
                                                ...
                                                <textarea class="form-control" name="descripcion" id="descripcion_id" placeholder="Escribe una descripción" style="height: 100px">{{old('descripcion')}}</textarea>
                                            @error('descripcion')
                                                <small class="text-danger">{{$message}}</small>
                                            @enderror
                                        </div>
                                ...
                                <div class="col-12 col-lg-5 py-1">
                                    ...
                                    <div class="card text-center imagecard rounded bg-light mb-0" style="height: 290px;">  
                                        <label for="uploadImage1" class=" my-auto text-center">
                                            <img for="uploadImage1" id="uploadPreview1" alt="" class="py-auto rounded" style="width: 80%; height: 300px;" src="/images/icon_foto.png">   
                                        </label>
                                    </div>
